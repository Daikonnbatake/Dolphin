...
template<class... Args>
inline void Dolphin::Struct::DolphinEvent<Args...>::AddEvent(callback<Args...> callback)
{
...
template<class... Args>
inline void Dolphin::Struct::DolphinEvent<Args...>::PopEvent(callback<Args...> callback)
{
